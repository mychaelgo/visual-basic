...
Begin VB.UserControl vbButton 
   ...
   PropertyPages   =   "vbButton.ctx":0000
   ScaleHeight     =   32
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   87
   ToolboxBitmap   =   "vbButton.ctx":0035
...
HasFocus = True
If ShowFocusRect Then isOver = True
Call Redraw(lastStat, True)
End Sub
...
HasFocus = False
If ShowFocusRect Then isOver = False
Call Redraw(lastStat, True)
End Sub
