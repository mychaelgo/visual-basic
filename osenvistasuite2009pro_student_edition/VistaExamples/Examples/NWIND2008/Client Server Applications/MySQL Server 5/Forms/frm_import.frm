...
Begin VB.Form frm_import 
   ...
   Begin VistaSuitePro.OsenVistaButton cmdImport 
      ...
      MCOL            =   16711935
      MPTR            =   99
      MICON           =   "frm_import.frx":038A
      PICN            =   "frm_import.frx":04EC
      UMCOL           =   -1  'True
      GradientColor   =   -1  'True
      GradientColor1  =   16777215
      GradientColor2  =   15779735
      GradientHover   =   -1  'True
   End
    ...
    If FileLen(SQL) Then
        ...
        If MyCN.State Then ' connectioin is active
            ...
            MsgBoxGT "All query/data was successful execute into " & MyCN.SQL_Result("select database()") & "@" & txtHost & vbCrLf & vbCrLf & _
                    ...
                    "Server Info: " & MyCN.HostInfo & " (" & MyCN.ServerVersionInfo & ")", vbInformation
                    
            
            Unload Me
            
        Else
            MsgBoxGT "Could not connect to the server ...", vbExclamation, "Connection failed", 3
        End If
