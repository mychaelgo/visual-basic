...
Begin VB.Form frm_employees 
   ...
   Begin VistaSuitePro.OsenVistaTab OsenXPTab1 
      ...
      Begin VistaSuitePro.OsenVistaPicture picX 
         ...
         EndProperty
         DescriptionLeft =   42
         BinaryImage     =   "frm_employees.frx":228E
      End
      Begin VistaSuitePro.OsenVistaDTPicker dtBirth 
         ...
         Mask            =   5
         Picture         =   "frm_employees.frx":22A6
         FadeInEffect    =   -1  'True
         BinaryImage     =   "frm_employees.frx":5E99
      End
      ...
      Begin VistaSuitePro.OsenVistaDTPicker dtHire 
         ...
         BorderColorOver =   12624503
         Mask            =   5
         Picture         =   "frm_employees.frx":5EB1
         FadeInEffect    =   -1  'True
         BinaryImage     =   "frm_employees.frx":9AA4
      End
...
Private Sub Form_Load()
    ...
    cboReportTo.InsertItemBySQL ADOCN, "spGetEmpFL", True, True
    cboReportTo.ColumnWidth(1) = 0

    ' Open recordset and Bind txtdata and PicX into MyADODC1
    MyADODC1.OpenRecordset "select * from employees", ADOCN, TxtData, , , picX
