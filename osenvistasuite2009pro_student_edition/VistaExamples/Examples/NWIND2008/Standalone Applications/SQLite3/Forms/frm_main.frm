...
Public Sub CreateNode()
    ...
    mStrSQL = "select privileges from users where userid like '" & StrUserID & "' "

    ' Get .....
    strPrivileges = MyCN.ExecScalar(mStrSQL)
...
'    Me.OsenXPForm1.MaximizeWindows
    ...
    vList.LargeIcons = Me.LargeIcons.hIml
    vList.SmallIcons = Me.SmallIcons.hIml
    ...
    Systray.Create "Northwind Traders 2007", Me.OsenXPPicture1.hWnd, OsenXPForm1.Icon
    '============================================================
...
Private Sub OsenXPToolBar1_ButtonClick(Index As Integer, _
    ...
    Select Case Index
        ...
        Case 8, 9
            ...
            FrmName = MyCN.ExecScalar(mStrSQL)
        ...
        Case 16
            ...
            RptName = MyCN.ExecScalar(mStrSQL)
...
Private Sub tvwMenus_NodeChange(Node As VistaSuitePro.CLS_xpNode)
    ...
    If Node.FirstSelected = False Then
        ...
        If MyCN.HaveRecords(mStrSQL) Then
        
            If MyCN.HaveRecords("view vw" & Node.DynamicLevel & "_" & Node.sp_SQL) Then
                
                tvwMenus.AddNodeByRecordset GetRST("view vw" & Node.DynamicLevel & "_" & Node.sp_SQL), 0, 1, , , Node.Key, 1, , , 2, 3, True
...
Private Sub tvwMenus_NodeClick(Node As VistaSuitePro.CLS_xpNode)
    ...
    Me.OsenXPForm1.Caption = "Northwind Traders 2008 [SQLite3 - " & MyCN.Version & "] - " & Node.FullPath
    ...
    Else
        ...
        mStrSQL = "view vw" & Node.DynamicLevel & "_" & Node.sp_SQL
        
        If MyCN.HaveRecords(mStrSQL) Then

            
            Dim StrA As String
            StrA = MyCN.ExecScalar("select flags from nodes where nodekey='" & Node.DynamicParentKey & "'")
...
Private Sub DeleteRecord(ByVal mTable As String)
    ...
    Select Case mTable
        ...
        Case "order"
            ...
            MyCN.Execute "delete from `order details` where orderid=" & KeyValue
            MyCN.Execute "delete from `orders` where orderid=" & KeyValue

        Case "user"
        
            MyCN.Execute "delete from users where userid like '" & KeyValue & "'"

        Case "employee"
        
            MyCN.Execute "delete from employees where employeeid=" & KeyValue
            
        Case "category"
        
            MyCN.Execute "delete from categories where categoryid=" & KeyValue
            
        Case "customer"
        
            MyCN.Execute "delete from customers where customerid like '" & KeyValue & "'"
            
        Case "product"
        
            MyCN.Execute "delete from products where productid=" & KeyValue
            
        Case "supplier"
        
            MyCN.Execute "delete from suppliers where supplierid=" & KeyValue
