...
Private Sub Form_Load()
    ...
    If IsNew Then
        ...
        ' Open recordset
        MyADODC1.OpenRecordset "select * from suppliers where supplierid=-1", ADOCN, txtData
    ...
    Else
        ...
        ' Open recordset
        MyADODC1.OpenRecordset "select * from suppliers where supplierid=" & KeyValue, ADOCN, txtData
