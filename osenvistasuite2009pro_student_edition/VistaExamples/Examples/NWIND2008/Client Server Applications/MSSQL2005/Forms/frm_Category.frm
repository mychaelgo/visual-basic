...
Private Sub Form_Load()
    ...
    If IsNew Then
        MyADODC1.OpenRecordset "select * from categories where categoryid=-1", ADOCN, txtData, , , picX
    Else
        MyADODC1.OpenRecordset "select * from categories where categoryid=" & KeyValue, ADOCN, txtData, , , picX
    End If
