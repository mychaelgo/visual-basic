...
Public Sub CreateNode()
    ...
    ' Get .....
    strPrivileges = MyCN.SQL_Result(mStrSQL)
...
'    vList.SoundHover = App.Path & "\resources\hover.wav"
    ...
    Systray.Create "Northwind Traders 2006", Me.OsenXPPicture1.hWnd, OsenXPForm1.Icon
    '============================================================
...
Private Sub OsenXPToolBar1_ButtonClick(Index As Integer, _
    ...
    Select Case Index
        ...
        Case 8, 9
            ...
            FrmName = MyCN.SQL_Result(mStrSQL)
        ...
        Case 16
            ...
            RptName = MyCN.SQL_Result(mStrSQL)
...
Private Sub tvwMenus_NodeChange(Node As VistaSuitePro.CLS_xpNode)
    ...
    If Node.FirstSelected = False Then
        ...
        mStrSQL = "select count(*) from nodes where nodekey='" & Node.DynamicParentKey & "' and havechild >= " & Node.DynamicLevel

        ' Check from the resultset
        If CInt(MyCN.ExecScalar(mStrSQL)) Then
        
            mStrSQL = Node.sp_MySQL("vw" & Node.DynamicLevel & "_")
            If MyCN.HaveRecords(mStrSQL) Then
                tvwMenus.AddNodeByRecordset GetRST(mStrSQL), 0, 1, , , Node.Key, 1, , , 2, 3, True
...
Private Sub tvwMenus_NodeClick(Node As VistaSuitePro.CLS_xpNode)
    ...
    Me.OsenXPForm1.Caption = "Northwind Traders 2008 [MySQL5 - " & gDB_Name & "] - " & Node.FullPath
    ...
    Else
        ...
        If CheckRecordsBySQL(mStrSQL) Then
            
            Dim StrA As String
            StrA = MyCN.SQL_Result("select flags from nodes where nodekey='" & Node.DynamicParentKey & "'")
...
Private Sub DeleteRecord(ByVal mTable As String)
    ...
    Select Case mTable
        ...
        Case "user"
            ...
            MyCN.Execute "delete from users where userid='" & KeyValue & "'"
        ...
        Case "customer"
            ...
            MyCN.Execute "delete from customers where customerid='" & KeyValue & "'"
