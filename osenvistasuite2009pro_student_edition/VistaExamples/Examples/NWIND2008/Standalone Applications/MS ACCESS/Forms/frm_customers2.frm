...
Private Sub Form_Load()
    ...
    If IsNew Then
        ...
        ' Open recordset
        MyADODC1.OpenRecordset "select * from customers where customerid='-1'", ADOCN, txtData
    ...
    Else
        ...
        ' Open recordset
        MyADODC1.OpenRecordset "select * from customers where customerid='" & KeyValue & "'", ADOCN, txtData
