...
Private Sub Form_Load()
    ...
    cboReportTo.InsertItemByRecordset GetRST("view spGetEmpFL"), True, True
    cboReportTo.ColumnWidth(1) = 0

    If IsNew Then
        MyADODC1.OpenSQLite3Table "employees", MyCN, " where employeeid=-1", txtData, picX
    Else
        MyADODC1.OpenSQLite3Table "employees", MyCN, " where employeeid=" & KeyValue, txtData, picX
    End If
