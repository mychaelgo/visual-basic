...
Private Sub Form_Load()
    ...
    If IsNew Then
        MyADODC1.OpenSQLite3Table "categories", MyCN, "where categoryid=-1", txtData, picX
    Else
        MyADODC1.OpenSQLite3Table "categories", MyCN, "where categoryid=" & KeyValue, txtData, picX
    End If
