...
'    DrawGradient4Pic Picture1
    ...
    ' Prepared Query
    If IsNew Then
        MyADODC1.OpenRecordset "select * from users where userid='-1'", ADOCN, txtData, , , picX
        MyADODC1.SendAction 5
    Else
        MyADODC1.OpenRecordset "select * from users where userid='" & KeyValue & "'", ADOCN, txtData, , , picX
