...
Begin VB.Form frm3_basic 
   ...
   EndProperty
   Icon            =   "frmeachcellicons.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   390
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   576
   ...
   Begin VistaSuitePro.OsenVistaButton OsenXPButton2 
      ...
      MCOL            =   16711935
      MPTR            =   0
      MICON           =   "frmeachcellicons.frx":429A
      UMCOL           =   -1  'True
      OffsetLeft      =   0
      OffsetTop       =   0
   ...
   Begin VistaSuitePro.OsenVistaButton OsenXPButton1 
      ...
      MCOL            =   16711935
      MPTR            =   0
      MICON           =   "frmeachcellicons.frx":42B6
      UMCOL           =   -1  'True
      OffsetLeft      =   0
      OffsetTop       =   0
      GradientColor   =   -1  'True
   ...
   Begin VistaSuitePro.MyImageList MyImageList1 
      ...
      _ExtentY        =   953
      Size            =   44772
      Images          =   "frmeachcellicons.frx":42D2
      Version         =   720920
      KeyCount        =   39
   ...
   Begin VistaSuitePro.OsenVistaForm OsenXPForm1 
      ...
      Caption         =   "Customize an icon for each cells"
      TitleTop        =   7
      icon            =   "frmeachcellicons.frx":F1D6
