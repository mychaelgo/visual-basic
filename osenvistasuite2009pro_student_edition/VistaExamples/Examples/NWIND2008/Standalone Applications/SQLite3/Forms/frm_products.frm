...
Private Sub Form_Load()
    ...
    If IsNew Then
        MyADODC1.OpenSQLite3Table "products", MyCN, "where productid=-1", txtData  ' open empty record
    Else
        MyADODC1.OpenSQLite3Table "products", MyCN, "where productid=" & KeyValue, txtData
    End If
