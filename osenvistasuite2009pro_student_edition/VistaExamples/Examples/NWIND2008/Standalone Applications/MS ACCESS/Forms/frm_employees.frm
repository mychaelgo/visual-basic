...
Private Sub Form_Load()
    ...
    cboReportTo.InsertItemByRecordset GetRST("spGetEmpFL"), True, True
    cboReportTo.ColumnWidth(1) = 0

    If IsNew Then
        MyADODC1.OpenRecordset "select * from employees where employeeid='-1'", ADOCN, txtData, , , picX
    Else
        MyADODC1.OpenRecordset "select * from employees where employeeid=" & KeyValue, ADOCN, txtData, , , picX
    End If
