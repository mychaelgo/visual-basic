...
Begin VB.Form frm_orders 
   ...
   Begin VistaSuitePro.MyContainerCtl MyContainerCtl1 
      ...
      Begin VB.PictureBox picContainer 
         ...
         Begin VistaSuitePro.OsenVistaFrame OsenXPFrame2 
            ...
            Appearance      =   1
            CaptionPosition =   1
            BinaryImage     =   "frm_sales_order.frx":058A
         ...
         Begin VistaSuitePro.OsenVistaDTPicker dtInfo 
            ...
            Mask            =   5
            Picture         =   "frm_sales_order.frx":05A2
            Required        =   -1  'True
            FadeInEffect    =   -1  'True
            BinaryImage     =   "frm_sales_order.frx":4195
         End
         Begin VistaSuitePro.OsenVistaFrame OsenXPFrame1 
            ...
            BorderColor     =   14396553
            Appearance      =   1
            image           =   "frm_sales_order.frx":41AD
            BinaryImage     =   "frm_sales_order.frx":4747
            GradientColor1  =   16773607
            GradientColor2  =   16768452
         ...
         Begin VistaSuitePro.OsenVistaListBox lstItemDetails 
            ...
            Lstyle          =   2
            ShowHeader      =   -1  'True
            HeaderFormatString=   $"frm_sales_order.frx":475F
            Columns         =   7
            ...
            Picture         =   "frm_sales_order.frx":47FD
            PicturePosition =   2
            ...
            BinaryImage     =   "frm_sales_order.frx":539C
            WindowColor     =   3
         End
         ...
         Begin VistaSuitePro.OsenVistaDTPicker dtInfo 
            ...
            BorderColorOver =   12624503
            Mask            =   5
            Picture         =   "frm_sales_order.frx":53B4
            FadeInEffect    =   -1  'True
            BinaryImage     =   "frm_sales_order.frx":8FA7
         End
         Begin VistaSuitePro.OsenVistaDTPicker dtInfo 
            Height          =   315
            Index           =   2
            ...
            BorderColorOver =   12624503
            Mask            =   5
            Picture         =   "frm_sales_order.frx":8FBF
            FadeInEffect    =   -1  'True
            BinaryImage     =   "frm_sales_order.frx":CBB2
         End
         Begin VB.Image Image1 
            Height          =   1335
            Left            =   420
            Picture         =   "frm_sales_order.frx":CBCA
            Top             =   150
            Width           =   3720
         End
   ...
   Begin VistaSuitePro.OsenVistaToolBar tBar 
      ...
      XPBlend         =   0   'False
      TotalButton     =   9
      Bpic1           =   "frm_sales_order.frx":1CEB4
      Bname1          =   "New"
      Btype1          =   0
      Bwidth1         =   0
      Bchecked1       =   0   'False
      Bvalue1         =   0   'False
      Bpic2           =   "frm_sales_order.frx":1D206
      Bname2          =   "Save"
      Btype2          =   0
      Bwidth2         =   0
      Bchecked2       =   0   'False
      Bvalue2         =   0   'False
      Bpic3           =   "frm_sales_order.frx":1D558
      Bname3          =   "Delete"
      Btype3          =   0
      Bwidth3         =   0
      Bchecked3       =   0   'False
      ...
      BNI4            =   0
      BSI4            =   0
      Bpic5           =   "frm_sales_order.frx":1D8AA
      ...
      Bchecked6       =   0   'False
      Bvalue6         =   0   'False
      Bpic7           =   "frm_sales_order.frx":1DBFC
      ...
      Bchecked8       =   0   'False
      Bvalue8         =   0   'False
      Bpic9           =   "frm_sales_order.frx":1DF4E
      Bname9          =   "Close"
      Btype9          =   0
      Bwidth9         =   0
      Bchecked9       =   0   'False
   ...
   Begin VistaSuitePro.OsenVistaStatusBar sBar 
      ...
      pTextAlignment1 =   0
      PanelPicture1   =   "frm_sales_order.frx":1E2A0
      ...
      pTextAlignment2 =   0
      pTextBold2      =   -1  'True
      PanelPicture2   =   "frm_sales_order.frx":1E5F2
      ...
      pTextAlignment3 =   0
      pTextBold3      =   -1  'True
      PanelPicture3   =   "frm_sales_order.frx":1E60E
      ...
      pTextAlignment4 =   0
      pTextBold4      =   -1  'True
      PanelPicture4   =   "frm_sales_order.frx":1E62A
...
Private Sub Form_Load()
    ...
    CboInfo.InsertItemByRecordset GetRST("SELECT * from vListCustomers;"), True
    ...
    CboSales.InsertItemByRecordset GetRST("select * from vlistemp"), True
...
Private Sub DIsplayOrderDetails(OrderID As String)
    ...
    If Len(OrderID) Then
        ...
        mStrSQL = "CALL vw_orderdetails(" & OrderID & ");"
...
Private Sub CreateNewOrder()
    ...
    ' insert new order
    mStrSQL = "insert into orders(orderdate) values(curdate())"
    
    MyCN.Execute mStrSQL
    
    ' get autonumber of OrderID from current recordset
    txtOrder = MyCN.Last_Insert_ID
